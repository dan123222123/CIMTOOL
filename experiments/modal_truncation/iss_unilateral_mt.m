...
contour = Numerics.Contour.Ellipse(-0.3067+61.3391i,0.025,1.5,5e2);
tc =      Numerics.Contour.Ellipse(-0.3+62i,0.025,1.5,5e2);
...
%% contour conga
g = @(x) x - 200*1i*x; gx = linspace(-0.3,0,1000); gls = g(gx);
...
wobj = 'cc_iss_unilateral.gif'; delete(wobj);
for i=1:length(gls)
